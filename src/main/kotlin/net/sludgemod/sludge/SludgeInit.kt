...
object SludgeInit : ModInitializer {
    ...
    override fun onInitialize() {
        ...
        SEPARATOR_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, Identifier(MOD_ID, "separator"), BlockEntityType.Builder.create(Supplier{ SeparatorBlockEntity() }, SEPARATOR_BLOCK).build(null))
